          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-1/3 flex flex-col items-center">
              ...
              <div className="flex flex-wrap gap-1 justify-center mb-4">
                {casino.has_mobile_app && <Badge variant="outline" className="text-xs">{t.featuredCasino.features.mobileApp}</Badge>}
                {casino.has_live_streaming && <Badge variant="outline" className="text-xs">{t.featuredCasino.features.liveStreaming}</Badge>}
                {casino.has_cash_out && <Badge variant="outline" className="text-xs">{t.featuredCasino.features.cashOut}</Badge>}
                {casino.has_live_betting && <Badge variant="outline" className="text-xs">{t.featuredCasino.features.liveBetting}</Badge>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12 sm:col-span-3 p-4">
                ...
                <div className="flex flex-wrap gap-1 mt-2">
                  {casino.has_mobile_app && <Badge variant="outline" className="text-xs bg-secondary/50">
                    {t.featuredCasino.features.mobileApp}</Badge>}
                  {casino.has_live_streaming && <Badge variant="outline" className="text-xs bg-secondary/50">
                    {t.featuredCasino.features.liveStreaming}</Badge>}
                  {casino.has_cash_out && <Badge variant="outline" className="text-xs bg-secondary/50">
                    {t.featuredCasino.features.cashOut}</Badge>}
                  {casino.has_live_betting && <Badge variant="outline" className="text-xs bg-secondary/50">
                    {t.featuredCasino.features.liveBetting}</Badge>}
                </div>
              </div>
